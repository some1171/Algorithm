package acmicpc.practicetwice.lab3;
...
public class Main {
	...
	public void pick(int pos, int count, boolean[] isPick) {
		if (count == M) {
			// bfs Å½»ö ½ÃÀÛ
			bfs(isPick);
			return;
	...
	public void bfs(boolean[] isPick) {
